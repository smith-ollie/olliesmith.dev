        ...
        return (
          <li key={index}>
            ...
            {index !== props.children.length - 1 ? (
              <hr className="relative !w-4 before:contrast-[6] before:gradient-mask-b-0 before:absolute before:left-0 before:top-0 before:right-0 before:bottom-0 before:bg-[radial-gradient(var(--tw-gradient-stops))] before:bg-repeat-round before:bg-left-top before:bg-[size:1em_1em] before:from-primary before:opacity-50 before:to-accent-white before:animate-[shimmer_60s_linear_infinite] hidden @[650px]:block" />
            ) : null}
          </li>
        );
      })}
